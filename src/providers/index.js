...
// Add optional boost tuning without making the normal card UI more complex.
// This runs after the legacy core and provider wrapper have registered the card.
queueMicrotask(()=>{
  ...
  Card.prototype.render=function(){
    ...
    gear.addEventListener("click",e=>{e.stopPropagation();panel.classList.toggle("open");gear.classList.toggle("on",panel.classList.contains("open"))});
