(() => {
  ...
  queueMicrotask(() => {
    ...
    if (!Card2 || Card2.prototype.__boostSettingsInstalled) return;
    Card2.prototype.__boostSettingsInstalled = true;
